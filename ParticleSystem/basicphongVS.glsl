...
void main() {
	...
	//gl_Position = projection_mat * vec4 (Eye, 1.0);        // projection * view * model*(position in local coordinate)  in here model is identity mat4 because have no pose in model
